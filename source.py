...
Label1.grid(row=1, column=2, columnspan=3, pady=70)
...
moviedropdown['values'] = ("Sholay", "Dilwale Dulhaniya Le Jayenge", "Don", "Dear Zindagi", "Tenet")  # movie names
...
display1 = Text(tab2, height=5, width=40)
display1.grid(row=2, column=1, columnspan=3, pady=30)
directors = ["Ramesh Sippy", "Aditya Chopra", "Farhan Akhtar", "Gauri Shinde", "Christopher Nolan"]
genres = ["Action/Drama", "Drama/Romance", "Acion/Drama", "Heartfelt/Real", "Drama"]
actors = ["Amitabh Bachchan, Hema Malini, Dharmendra", "Kajol, Shahrukh Khan", "Shahrukh Khan, Priyanka Chopra", "Alia Bhatt, Shahrukh Khan", "Robert Pattinson, Dimple Kapadia"]
runtimes = ["180", "150", "140", "130", "120"]
DetailL = Label(tab2, text="Details")
DetailL.grid(row=2, column=0)

#proceed to step 2 Butt
buttonproceed = Button(tab2, text="Proceed to Book", width=25, bg='#76c6ba')
...
showsdropdown = ttk.Combobox(buttonproceed, width=50, state="readonly")
showsdropdown['values'] = ["0700", "0930", "1200", "1445", "1805", "2030", "2330"]
showsdropdown.grid(row=0, column=1, columnspan=3, padx=20, pady=20)
button2 = Button(buttonproceed, text='Select', bg='#76c6ba', command=lambda: getShowTime())
button2.grid(row=1, column=2)

# About
about_label = Label(
    tab4, text="BookMyTicket \n Movie Ticket Booking System \n\n Made by \n Gaurav Kulkarni \n Jui Kulkarni \n Abdul Aseem Shaikh \n(As DSL Mini Project)", anchor="center",  font=("Times", 20))
...
def menu2():
    ...
    ticketcount = Entry(Booking, width=10, state='readonly')
    ticketcount.grid(row=3, column=2, padx=10, pady=10)
