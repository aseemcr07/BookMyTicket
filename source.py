...
tab_control.add(tab3, text=f'{"Seating":^30s}', command=lambda: displaySeating())
tab_control.add(tab4, text=f'{"About":^30s}')
tab_control.pack(expand=1, fill="both")

# HOME
Label1 = Label(tab1, text='Welcome to JAG Theater',
...
def menu2():
    ...
    calculate = Button(Booking, text="Calculate")
